...
class getApiPlatform_JsonSchema_JsonSchemaGenerateCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['api_platform.json_schema.json_schema_generate_command'] = $instance = new \ApiPlatform\JsonSchema\Command\JsonSchemaGenerateCommand(($container->privates['api_platform.json_schema.schema_factory'] ?? $container->load('getApiPlatform_JsonSchema_SchemaFactoryService')), $container->parameters['api_platform.formats']);
